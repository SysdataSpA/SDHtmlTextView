...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html=loadStringFromAssetFile(this,"testHtmlStyle.html");

//        HtmlSpanTextView textView = (HtmlSpanTextView) findViewById(R.id.html_text);
//
...
//                "    Pellentesque consectetur risus metus, <a style=\"font-family:Poppins\" href=\"http://www.google.com\">Google</a> tempor dolor rhoncus quis. Suspendisse vitae arcu placerat, feugiat diam sed, rutrum justo. \nPraesent mi nunc, dictum lacinia nibh vitae, lacinia eleifend nibh. <span style=\"background-color:#f17;color:white;\">Donec feugiat est vel libero tristique,</span> sed aliquam ipsum mattis. Ut pretium, mi id scelerisque blandit, justo lectus ornare nunc, ac posuere arcu mauris nec sapien. Curabitur pharetra, sapien ac accumsan scelerisque, eros augue tincidunt arcu, at sagittis eros nibh at lorem. Vivamus vitae pulvinar mi, ac vestibulum nulla. In eget arcu enim. Fusce egestas ullamcorper risus, non pellentesque mauris feugiat at."+
//                "    </p>" +
//                "</div>";
